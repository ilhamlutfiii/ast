...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Jabatan List</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        <span style="float:right">{!! $jabatans->links('pagination::bootstrap-4')->withQueryString(['left' => 3, 'right' => 3]) !!}</span>
      </div>
    </div>
</div>
@endsection
