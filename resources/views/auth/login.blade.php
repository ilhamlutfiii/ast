                ...
                <div class="p-5">
                  ...
                  <form class="user"  method="POST" action="{{ route('login.submit') }}">
                    ...
                    <div class="form-group">
                      <input type="user_nid" class="form-control form-control-user @error('user_nid') is-invalid @enderror" name="user_nid" value="{{ old('user_nid') }}"  placeholder="Enter User Nid Address..."  autofocus>
                        @error('user_nid')
